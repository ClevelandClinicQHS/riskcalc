    ...
    sidebarLayout(
      ...
      mainPanel(
        ...
        p(
          ...
          " | ",
          a("Source Code", href = "https://github.com/ClevelandClinicQHS/riskcalc-website", style = "font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-size: 15px;color: #2c3e50;font-weight: bold;text-align: center;text-decoration: underline;"),
